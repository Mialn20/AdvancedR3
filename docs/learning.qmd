...
19.6 What is the estimated relationship of each metabolite with type 1
...
```{r}
tar_read(all_models_results) |> 
  knitr::kable(
    caption = "Results of the data analysis fitting multiple models to each metabolite."
  )
```
...
tar_read(all_models_results) |> 
  ...
  ggplot2::facet_grid(cols = vars(model))
